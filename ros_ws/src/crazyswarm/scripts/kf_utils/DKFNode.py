...
from kf_utils.target import DEFAULT_H
...
class DKFNode:
    ...
    def update(self, measurements):
        ...
        if len(H) == 0:
            # TODO IF NO OBSERVATIONS, SET FLAG TO REPOSITION AROUND DRONE THAT HAS MADE OBSERVATION
            # ASSUME THAT ALL DRONES SEE TARGETS INITIALLY
